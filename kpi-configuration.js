...
]))+panel('Score-based KPI Threshold Preview','<div class="kpi-cfg-threshold"><span class="on">On Track <b>≥ '+esc(t.on_track_percent)+'%</b></span><span class="risk">At Risk <b>'+esc(t.at_risk_percent)+'–'+esc(Number(t.on_track_percent)-0.1)+'%</b></span><span class="off">Off Track <b>&lt; '+esc(t.at_risk_percent)+'%</b></span><span class="missing">Data Missing <b>required value absent</b></span></div>','These bands classify KPI scores when worst-indicator status is disabled; individual indicators retain their target-operator checks.');}
