...
const testFiles = [
  ...
  'tests/kpi_configuration_preview.test.cjs',
  'tests/kpi_preview_integration.test.cjs',
  ...
  'tests/kpi_monthly_table_visibility.test.cjs',
  'tests/kpi_action_form.test.cjs',
  'tests/kpi_monthly_save_outcome.test.cjs',
  'tests/kpi_entry_accessibility.test.cjs',
  ...
  'tests/kpi_archive_safety.test.cjs',
  'tests/kpi_editor_focus.test.cjs',
  'tests/kpi_objective_colour.test.cjs',
  'tests/kpi_indicator_navigation.test.cjs',
  ...
  ,'tests/record_workspace_interaction.test.cjs'
  ,'tests/action_record_workspace.test.cjs'
  ,'tests/view_engine_interaction.test.cjs'
  ,'tests/action_list_workspace.test.cjs'
  ,'tests/risk_list_workspace.test.cjs'
  ,'tests/incident_list_workspace.test.cjs'
  ...
  ,'tests/app_launcher_icon_contract.test.cjs'
  ,'tests/moc_list_workspace.test.cjs'
  ,'tests/moc_record_workspace.test.cjs'
  ,'tests/permit_list_workspace.test.cjs'
  ,'tests/permit_record_workspace.test.cjs'
  ,'tests/toolbox_list_workspace.test.cjs'
  ,'tests/toolbox_record_workspace.test.cjs'
