...
async function main() {
  ...
  requireMarkers(assetSources.get('auris-view-engine.js'), 'Application view engine', [
    "version:'1.1.0'", 'definition:definition', 'model:model', 'mount:mount', 'diagnostics:diagnostics'
  ]);
