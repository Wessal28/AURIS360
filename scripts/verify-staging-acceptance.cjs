...
for (const fileName of ['auris-module-registry.js', 'auris-platform-services.js', 'auris-module-runtime.js', 'auris-application-lifecycle.js', 'auris-application-lifecycle-persistence.js', 'auris-command-centre.js', 'auris-view-engine.js', 'auris-record-workspace.js', 'auris-action-record-workspace.js', 'auris-record-edit-session.js', 'auris-form-draft.js', 'kpi-editor-drafts.js', 'auris-action-editor.js', 'auris-action-list-workspace.js', 'auris-moc-list-workspace.js', 'auris-moc-record-workspace.js', 'auris-toolbox-list-workspace.js', 'auris-toolbox-record-workspace.js', 'auris-permit-list-workspace.js', 'auris-permit-record-workspace.js', 'auris-risk-list-workspace.js', 'auris-incident-list-workspace.js', 'auris-tools-list-workspace.js', 'auris-audit-list-workspace.js', 'auris-contractor-list-workspace.js', 'auris-fleet-list-workspace.js', 'auris-atex-list-workspace.js', 'auris-fire-list-workspace.js', 'auris-chemical-list-workspace.js', 'auris-legal-list-workspace.js', 'auris-ppe-list-workspace.js', 'auris-reporting-engine.js', 'auris-dashboard-designer.js', 'auris-automation-engine.js', 'auris-automation-centre.js', 'auris-integration-engine.js', 'auris-integration-centre.js', 'auris-module-extraction.js', 'auris-extracted-module-adapters.js', 'auris-module-layout.js', 'auris-workflow-service.js', 'auris-approval-centre.js', 'auris-priority-module-adapters.js', 'auris-applications-admin.js', 'auris-workflow-studio.js', 'auris-work-centre.js', 'auris-core.js', 'kpi-definition-editor.js', 'kpi-module-upgrade.js', 'kpi-workflow.js', 'kpi-data-source.js', 'safety-engagement.js', 'document-control-upgrade.js']) {
