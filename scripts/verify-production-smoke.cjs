...
async function verifyProduction(options, evidence) {
  ...
  const assets = [
    ...
    ['auris-record-workspace.js', ["version:'1.1.0'", 'registerAdapter:registerAdapter', 'exactSource:exactSource', 'model:model', 'open:open', 'diagnostics:diagnostics', 'assertCurrentSession', 'data-record-feedback']],
