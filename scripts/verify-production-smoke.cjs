...
async function main() {
  ...
  const assets = [
    ...
    ['auris-workflow-service.js', ["version:'2.0.0'", 'configure:configure', 'requireTransition:requireTransition']],
    ['auris-approval-centre.js', ["version:'2.0.0'", 'registerAdapters:registerAdapters', 'assertSource:assertSource']],
