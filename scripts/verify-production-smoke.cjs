...
async function verifyProduction(options, evidence) {
  ...
  const assets = [
    ...
    ['auris-tools-list-workspace.js', ["version:'1.1.0'", 'assertSession', 'inspectionFor:inspectionFor', 'project:project', 'mount:mount']],
    ['auris-work-schedule-workspace.js', ['wsOpenRecordRequest', 'assertSession', 'project:project', 'mount:mount']],
    ...
    ['auris-contractor-list-workspace.js', ["version:'1.0.0'", 'assertSession', 'dateState:dateState', 'project:project', 'mount:mount']],
    ['auris-fleet-list-workspace.js', ["version:'1.0.0'", 'assertSession', 'checkState:checkState', 'project:project', 'mount:mount']],
    ['auris-atex-list-workspace.js', ["version:'1.0.0'", 'assertSession', 'dateState:dateState', 'project:project', 'mount:mount']],
    ['auris-fire-list-workspace.js', ["version:'1.0.0'", 'assertSession', 'dateState:dateState', 'project:project', 'mount:mount']],
    ...
    ['auris-meetings-list-workspace.js', ["version:'1.0.0'", 'assertSession', 'dateState:dateState', 'project:project', 'mount:mount']],
    ['auris-training-plan-list-workspace.js', ["version:'1.0.0'", 'assertSession', 'dateState:dateState', 'project:project', 'mount:mount']],
