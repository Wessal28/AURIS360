...
async function main() {
  ...
  const assets = [
    ...
    ['auris-integration-engine.js', ["version:'1.2.0'", 'connection:connection', 'event:event', 'delivery:delivery', 'exportCsv:exportCsv', 'parseCsv:parseCsv', 'importPlan:importPlan', 'stagedImport:stagedImport', 'stagedReconciliation:stagedReconciliation']],
    ['auris-integration-centre.js', ["version:'1.2.0'", 'mount:mount', 'load:load', 'canManage:canManage', 'Stage reviewed import', 'Stage reviewed update', 'Safe rollback']],
