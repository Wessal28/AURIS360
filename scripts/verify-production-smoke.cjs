...
async function main() {
  ...
  const assets = [
    ...
    ['auris-integration-engine.js', ["version:'1.0.0'", 'connection:connection', 'event:event', 'delivery:delivery', 'exportCsv:exportCsv', 'parseCsv:parseCsv', 'importPlan:importPlan']],
    ['auris-integration-centre.js', ["version:'1.0.0'", 'mount:mount', 'load:load', 'canManage:canManage', 'Dry-run only']],
