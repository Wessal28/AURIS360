...
const assets={
 '/':['text/html',read('tests/fixtures/kpi-indicator-identity.html').replace('<!-- KPI_PANEL -->',html.slice(start,end)+confirmation)],
...
for(const f of ['kpi-definition-editor.js','auris-form-draft.js','kpi-editor-drafts.js','auris-settings-static.css','auris-base.css','auris-kpi-legacy.css','kpi-module-upgrade.css','kpi-module-upgrade.js','auris-static-event-handlers.js','auris-generated-event-handlers.js'])assets['/'+f]=[f.endsWith('.css')?'text/css':'text/javascript',read(f)];
