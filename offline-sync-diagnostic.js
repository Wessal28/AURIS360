...
function render(result){
  ...
  h+='<div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:12px"><button class="btn btn-primary" onclick="runOfflineSyncDiagnostic()"><i class="ti ti-player-play"></i>Run safe preflight</button>'+(result?'<button class="btn" onclick="clearOfflineSyncDiagnostic()"><i class="ti ti-trash"></i>Clear result</button>':'')+'</div>'
