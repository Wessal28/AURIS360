...
test('the complete smoke probe accepts the real application shell and all critical assets', async (t) => {
  ...
  assert.equal(result.assets.length, 64);
  ...
  assert.ok(response.requests.includes('/auris-risk-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-tools-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-incident-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-audit-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-contractor-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-fleet-list-workspace.js'));
  ...
  assert.ok(response.requests.includes('/auris-ppe-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-ohealth-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-emergency-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-esg-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-noise-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-meetings-list-workspace.js'));
  assert.ok(response.requests.includes('/auris-training-plan-list-workspace.js'));
