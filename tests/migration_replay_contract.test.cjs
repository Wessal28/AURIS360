...
test('reviewed migration replay inventory includes planned-month validation', () => {
  assert.deepEqual(expectations, { format_version: 1, tables: 270, policies: 435, routines: 128 });
});
