...
test('reviewed migration replay inventory includes Phase 25 shared master-data objects', () => {
  assert.deepEqual(expectations, { format_version: 1, tables: 269, policies: 431, routines: 118 });
});
