...
test('reviewed migration replay inventory includes Phase 20 integration objects', () => {
  assert.deepEqual(expectations, { format_version: 1, tables: 259, policies: 421, routines: 90 });
});
