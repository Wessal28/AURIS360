...
test('application loads services before runtime and core compatibility adapters',()=>{
  ...
  assert.ok(html.indexOf('auris-module-registry.js?v=20260903-29')<html.indexOf('auris-platform-services.js?v=20260831-3'));
  assert.ok(html.indexOf('auris-platform-services.js?v=20260831-3')<html.indexOf('auris-module-runtime.js?v=20260901-13'));
  assert.ok(html.indexOf('auris-module-runtime.js?v=20260901-13')<html.indexOf('auris-core.js?v=20260903-29'));
