...
function render(result){
  ...
  h+='<div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:12px"><button class="btn btn-primary" onclick="runRollbackRehearsal()"><i class="ti ti-player-play"></i>Run safe rehearsal</button>'+(result?'<button class="btn" onclick="clearRollbackRehearsal()"><i class="ti ti-trash"></i>Clear result</button>':'')+'</div>'
