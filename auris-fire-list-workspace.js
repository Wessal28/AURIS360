...
root.AurisFireListWorkspace=Object.freeze({version:'1.0.0',session:session,assertSession:assertSession,mount:mount,project:project,definition:definition,filters:filters,dateState:dateState});
