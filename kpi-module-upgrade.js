...
async function kpiXSubmitMonth(){if(window.KpiMonthlyReview)return window.KpiMonthlyReview.open();if(typeof toast==='function')toast('Monthly review is still loading. Please retry.',false);}
