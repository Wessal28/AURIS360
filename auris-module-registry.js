...
var modules = [
  ...
  {key:'events',name:'Incident Management',shortName:'Incidents',icon:'ti-alert-triangle',color:'#DC2626',category:'Operations',legacySection:'HSE Modules',order:100,companyScoped:true,loader:'loadEvents',dependencies:['people','actions'],layout:{defaultView:'dashboard',views:['dashboard','mywork','report','register','triage','investigate','actions','regulatory','lessons','reports','configuration']},lifecycle:{managed:true},workflow:{entity:'incident',initial:'draft',terminal:['closed','cancelled'],states:['draft','submitted','triage','under_investigation','verification','management_review','closed','cancelled'],transitions:[['draft','submitted'],['draft','cancelled'],['submitted','triage'],['submitted','cancelled'],['triage','under_investigation'],['triage','cancelled'],['under_investigation','verification'],['verification','under_investigation'],['verification','management_review'],['management_review','under_investigation'],['management_review','closed']]}},
