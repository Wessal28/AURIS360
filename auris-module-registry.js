...
var modules = [
  ...
  {key:'kpi',name:'Objectives & KPIs',shortName:'KPIs',icon:'ti-target',color:'#185FA5',category:'Governance',legacySection:'HSE Modules',order:540,companyScoped:true,loader:'kpiLoadAll',dependencies:['dashboard','people'],layout:{defaultView:'scorecard',views:['dashboard','scorecard','monthly','actions','reports','configuration']},lifecycle:{managed:true},workflow:{entity:'kpi',initial:'draft',terminal:['locked'],states:['draft','submitted','verified','approved','locked','rejected','revision_requested'],transitions:[['draft','submitted'],['submitted','verified'],['submitted','rejected'],['submitted','revision_requested'],['verified','approved'],['verified','rejected'],['verified','revision_requested'],['approved','locked'],['rejected','draft'],['rejected','submitted'],['revision_requested','draft'],['revision_requested','submitted']],approvalTransitions:[['submitted','verified'],['verified','approved']],rules:[{from:'draft',to:'submitted',roles:['hse_officer','hse_manager','admin','sephs_admin'],requiredFields:['reviewer','approver','data_provider','data_source']},{from:'submitted',to:'verified',approvalStages:[{role:'hse_officer',label:'KPI verification'}]},{from:'verified',to:'approved',approvalStages:[{role:'hse_manager',label:'KPI approval'}]},{from:'approved',to:'locked',roles:['hse_manager','admin','sephs_admin']},{from:'rejected',to:'submitted',roles:['hse_officer','hse_manager','admin','sephs_admin'],requiredFields:['reviewer','approver','data_provider','data_source']},{from:'revision_requested',to:'submitted',roles:['hse_officer','hse_manager','admin','sephs_admin'],requiredFields:['reviewer','approver','data_provider','data_source']}]}},
