...
| 6 Aug 2026 | AP-023 legacy action-source backfill | Migration ready; execution pending | `action_source_relationship_backfill_v2.sql` normalises known legacy aliases, auto-links only unique company-scoped reference matches, preserves existing links, and creates an RLS-protected review queue for ambiguous or unresolved records |
